function getOnlyEvens(nums) {
	return nums.filter((a,index)=> a%2===0 && index%2===0) 
}
...
console.log(getOnlyEvens([38, 24, 4, 49, 5, 33, 1, 10, 3]), [38, 4])
console.log(getOnlyEvens([46]), [46])
console.log(getOnlyEvens([13, 6, 12, 23, 31, 14, 2]), [12, 2])
console.log(getOnlyEvens([7, 1, 34, 14, 26, 3, 7, 7]), [34, 26])
console.log(getOnlyEvens([31, 11, 26, 19, 45, 12]), [26])
console.log(getOnlyEvens([22]), [22])
console.log(getOnlyEvens([29, 11]), [])
console.log(getOnlyEvens([6, 6, 37, 10, 4]), [6, 4])
console.log(getOnlyEvens([6, 46, 12, 47, 49, 26, 40, 28, 38]), [6, 12, 40, 38])
console.log(getOnlyEvens([31]), [])
console.log(getOnlyEvens([28, 44, 4, 31, 30, 46, 37]), [28, 4, 30])
console.log(getOnlyEvens([24]), [24])
console.log(getOnlyEvens([23, 41, 49, 5, 0, 46, 15, 15]), [0])
console.log(getOnlyEvens([44, 39, 15]), [44])